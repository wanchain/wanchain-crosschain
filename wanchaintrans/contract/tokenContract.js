...
module.exports = class tokenContract extends IContract
{
    constructor(tokenAddress)
    {
        super(wanAbi,'balanceOf',tokenAddress);
    }
    transfer(toAddress,IAmount){
        let funcInterface = this.getFuncInterface('transfer');
        if(funcInterface)
        {
    ...
    balanceOf(address,callback){
        let funcInterface = this.getFuncInterface('balanceOf');
        if(funcInterface)
        {
            return funcInterface(address,callback);
        }
    }
